...
public class fragment_split_spares extends Fragment {

    private String Maincategory = "Spares", Category = "SplitAC";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_split_spares, container, false);
