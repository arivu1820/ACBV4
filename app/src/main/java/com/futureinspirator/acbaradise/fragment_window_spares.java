...
public class fragment_window_spares extends Fragment {

    private String Maincategory = "Spares", Category = "WindowAC";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_window_spares, container, false);
