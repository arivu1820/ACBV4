...
public class splitac_installuninstall_bsd extends BottomSheetDialogFragment {
    ...
    private CardView split_install_addbtn_cardview1;
    private CardView split_install_progressbar;

    private Button split_uninstall_addbutton;
    private Button split_uninstall_minusbtn;
    private Button split_uninstall_plusbtn;
    private TextView split_uninstall_txt;
    private CardView split_uninstall_addbtn_cardview1;
    private CardView split_uninstall_pmt_cardview2;
    private CardView split_uninstall_progressbar;

    private Button split_combo_addbutton;
    private Button split_combo_minusbtn;
    private Button split_combo_plusbtn;
    private TextView split_combo_txt;
    private CardView split_combo_addbtn_cardview1;
    private CardView split_combo_pmt_cardview2;
    private CardView split_combo_progressbar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_splitac_installuninstall_bsd, container, false);
        ...
        cart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                split_install_txt.setText("" + installdatabaseQvalue);
                int intinstalldatabaseQvalue = Integer.parseInt(installdatabaseQvalue);

                if (intinstalldatabaseQvalue <= 0) {
                    split_install_pmt_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    split_install_pmt_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        cart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                split_uninstall_txt.setText("" + uninstalldatabaseQvalue);
                int intuninstalldatabaseQvalue = Integer.parseInt(uninstalldatabaseQvalue);
                if (intuninstalldatabaseQvalue <= 0) {
                    split_uninstall_pmt_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    split_uninstall_pmt_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        cart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                split_combo_txt.setText("" + combodatabaseQvalue);
                int intcombodatabaseQvalue = Integer.parseInt(combodatabaseQvalue);
                if (intcombodatabaseQvalue <= 0) {
                    split_combo_pmt_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    split_combo_pmt_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        txt_originalprice_combo_cassetteac=v.findViewById(R.id.txt_originalprice_combo_cassetteac);


        split_install_addbutton = v.findViewById(R.id.split_install_addbutton);
        split_install_minusbtn = v.findViewById(R.id.split_install_minusbtn);
        split_install_plusbtn = v.findViewById(R.id.split_install_plusbtn);
        split_install_txt = v.findViewById(R.id.split_install_txt);
        split_install_addbtn_cardview1 = v.findViewById(R.id.split_install_addbtn_cardview1);
        split_install_pmt_cardview2 = v.findViewById(R.id.split_install_pmt_cardview2);
        split_install_progressbar = v.findViewById(R.id.split_install_progressbar);


        split_uninstall_addbtn_cardview1 = v.findViewById(R.id.split_uninstall_addbtn_cardview1);
        split_uninstall_pmt_cardview2 = v.findViewById(R.id.split_uninstall_pmt_cardview2);
        split_uninstall_addbutton = v.findViewById(R.id.split_uninstall_addbutton);
        split_uninstall_plusbtn = v.findViewById(R.id.split_uninstall_plusbtn);
        split_uninstall_minusbtn = v.findViewById(R.id.split_uninstall_minusbtn);
        split_uninstall_txt = v.findViewById(R.id.split_uninstall_txt);
        split_uninstall_progressbar = v.findViewById(R.id.split_uninstall_progressbar);


        split_combo_addbtn_cardview1 = v.findViewById(R.id.split_combo_addbtn_cardview1);
        split_combo_pmt_cardview2 = v.findViewById(R.id.split_combo_pmt_cardview2);
        split_combo_addbutton = v.findViewById(R.id.split_combo_addbutton);
        split_combo_plusbtn = v.findViewById(R.id.split_combo_plusbtn);
        split_combo_minusbtn = v.findViewById(R.id.split_combo_minusbtn);
        split_combo_txt = v.findViewById(R.id.split_combo_txt);
        split_combo_progressbar = v.findViewById(R.id.split_combo_progressbar);
        ...
        split_install_addbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_install_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_install_progressbar.setVisibility(View.VISIBLE);
                split_install_quantity("add");
                totalquantity("add");
                totalprice("add", installprice,disinstallprice,"Install");
                split_install_price("add",installprice);
                btn("false");
            }
        });
        split_install_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_install_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_install_progressbar.setVisibility(View.VISIBLE);
                ...
                split_install_price("add",installprice-disinstallprice);
                totalsaved("add",disinstallprice,"Install");
                btn("false");
            }
        });
        split_install_minusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_install_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_install_progressbar.setVisibility(View.VISIBLE);
                split_install_quantity("sub");
                totalquantity("sub");
                totalprice("sub", installprice-disinstallprice,disinstallprice,"Install");
                split_install_price("sub",installprice-disinstallprice);
        ...
        split_uninstall_addbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_uninstall_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_uninstall_progressbar.setVisibility(View.VISIBLE);
                split_uninstall_quantity("add");
                totalquantity("add");
                totalprice("add", uninstallprice,disuninstallprice,"Uninstall");
                split_uninstall_price("add",uninstallprice);
                btn("false");
            }
        });
        split_uninstall_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_uninstall_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_uninstall_progressbar.setVisibility(View.VISIBLE);
                ...
                split_uninstall_price("add",uninstallprice-disuninstallprice);
                totalsaved("add",disuninstallprice,"Uninstall");
                btn("false");
            }
        });
        split_uninstall_minusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_uninstall_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_uninstall_progressbar.setVisibility(View.VISIBLE);
                split_uninstall_quantity("sub");
                totalquantity("sub");
                totalprice("sub", uninstallprice-disuninstallprice,disuninstallprice,"Uninstall");
                split_uninstall_price("sub",uninstallprice-disuninstallprice);
        ...
        split_combo_addbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_combo_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_combo_progressbar.setVisibility(View.VISIBLE);
                split_combo_quantity("add");
                totalquantity("add");
                totalprice("add", comboprice,discomboprice,"Combo");
                split_combo_price("add",comboprice);
                btn("false");
            }
        });
        split_combo_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_combo_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_combo_progressbar.setVisibility(View.VISIBLE);
                ...
                split_combo_price("add",comboprice-discomboprice);
                totalsaved("add",discomboprice,"Combo");
                btn("false");
            }
        });
        split_combo_minusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                split_combo_addbtn_cardview1.setVisibility(View.INVISIBLE);
                split_combo_progressbar.setVisibility(View.VISIBLE);
                split_combo_quantity("sub");
                totalquantity("sub");
                totalprice("sub", comboprice-discomboprice,discomboprice,"Combo");
                split_combo_price("sub",comboprice-discomboprice);
...
//                    footer.setVisibility(View.VISIBLE);
    ...
    private void btn(String action) {
        if (action == "false") {
            split_install_addbutton.setEnabled(false);
            split_install_minusbtn.setEnabled(false);
            split_install_plusbtn.setEnabled(false);
            split_uninstall_addbutton.setEnabled(false);
            split_uninstall_minusbtn.setEnabled(false);
            split_uninstall_plusbtn.setEnabled(false);
            split_combo_addbutton.setEnabled(false);
            split_combo_minusbtn.setEnabled(false);
            split_combo_plusbtn.setEnabled(false);
        } else if (action == "true") {
            split_install_addbutton.setEnabled(true);
            split_install_minusbtn.setEnabled(true);
            split_install_plusbtn.setEnabled(true);
            split_uninstall_addbutton.setEnabled(true);
            split_uninstall_minusbtn.setEnabled(true);
            split_uninstall_plusbtn.setEnabled(true);
            split_combo_addbutton.setEnabled(true);
            split_combo_minusbtn.setEnabled(true);
            split_combo_plusbtn.setEnabled(true);
        }
    }

    // INSTALL

    private void split_install_quantity(String action) {
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            split_install_pmt_cardview2.setVisibility(View.VISIBLE);
                            split_install_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("Installuninstall").child(Category).updateChildren(cartt);
                            if (installcount <= 0) {
                                split_install_addbtn_cardview1.setVisibility(View.VISIBLE);
                                split_install_pmt_cardview2.setVisibility(View.INVISIBLE);
                                split_install_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
    ...
    private void split_install_price(String action,int price) {
        if(action=="add")
        {
            cart.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
    ...
    //UNINSTALL
    private void split_uninstall_quantity(String action) {
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("Installuninstall").child(Category).updateChildren(cartt);
                            split_uninstall_pmt_cardview2.setVisibility(View.VISIBLE);
                            split_uninstall_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("Installuninstall").child(Category).updateChildren(cartt);
                            if (uninstallcount <= 0) {
                                split_uninstall_addbtn_cardview1.setVisibility(View.VISIBLE);
                                split_uninstall_pmt_cardview2.setVisibility(View.INVISIBLE);
                                split_uninstall_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
    ...
    private void split_uninstall_price(String action,int price) {
        if(action=="add")
        {
            cart.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
    ...
    private void split_combo_quantity(String action) {
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("Installuninstall").child(Category).updateChildren(cartt);
                            split_combo_pmt_cardview2.setVisibility(View.VISIBLE);
                            split_combo_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("Installuninstall").child(Category).updateChildren(cartt);
                            if (combocount <= 0) {
                                split_combo_addbtn_cardview1.setVisibility(View.VISIBLE);
                                split_combo_pmt_cardview2.setVisibility(View.INVISIBLE);
                                split_combo_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
    ...
    private void split_combo_price(String action,int price) {
        if(action=="add")
        {
            cart.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
