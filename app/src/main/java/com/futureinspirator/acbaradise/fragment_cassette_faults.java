...
public class fragment_cassette_faults extends Fragment {

    private String Maincategory = "Faults", Category = "CassetteAC";
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            {
                                pcboardcount = pcboardcount - price - disgasleakprice;
                            }
                            else
                            {
                                pcboardcount = pcboardcount - price;
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            {
                                indoorcoilcount = indoorcoilcount - price - disgasleakprice;
                            }
                            else
                            {
                                indoorcoilcount = indoorcoilcount - price;
