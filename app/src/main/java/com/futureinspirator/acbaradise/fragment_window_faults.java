...
public class fragment_window_faults extends Fragment {

    private String Maincategory = "Faults", Category = "WindowAC";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_window_faults, container, false);
