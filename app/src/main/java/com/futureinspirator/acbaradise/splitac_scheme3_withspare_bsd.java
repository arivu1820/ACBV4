...
public class splitac_scheme3_withspare_bsd extends BottomSheetDialogFragment {

    private String Maincategory = "Scheme3",Category = "Withspare";
    private CardView scheme3_withspare_totalspare_cardview1,scheme3_withspare_totalspare_cardview2,scheme3_withspare_limitedspare_cardview1,scheme3_withspare_limitedspare_cardview2;
    private CardView scheme3_withspare_totalspare_progressbar,scheme3_withspare_limitedspare_progressbar;
    private Button scheme3_withspare_totalspare_addbtn,scheme3_withspare_limitedspare_addbtn;
    private Button scheme3_withspare_totalspare_subbtn,scheme3_withspare_limitedspare_subbtn;
    private TextView scheme3_withspare_totalspare_counttxt,scheme3_withspare_limitedspare_counttxt;
    private Button scheme3_withspare_totalspare_plusbtn,scheme3_withspare_limitedspare_plusbtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_splitac_scheme3_withspare_bsd, container, false);

        footer = v.findViewById(R.id.footer);

        scheme3_withspare_totalspare_cardview1 = v.findViewById(R.id.scheme3_withspare_totalspare_cardview1);
        scheme3_withspare_totalspare_cardview2 = v.findViewById(R.id.scheme3_withspare_totalspare_cardview2);
        scheme3_withspare_limitedspare_cardview1 = v.findViewById(R.id.scheme3_withspare_limitedspare_cardview1);
        scheme3_withspare_limitedspare_cardview2 = v.findViewById(R.id.scheme3_withspare_limitedspare_cardview2);

        scheme3_withspare_totalspare_addbtn  = v.findViewById(R.id.scheme3_withspare_totalspare_addbtn);
        scheme3_withspare_limitedspare_addbtn  = v.findViewById(R.id.scheme3_withspare_limitedspare_addbtn);

        scheme3_withspare_totalspare_subbtn = v.findViewById(R.id.scheme3_withspare_totalspare_subbtn);
        scheme3_withspare_limitedspare_subbtn = v.findViewById(R.id.scheme3_withspare_limitedspare_subbtn);

        scheme3_withspare_totalspare_counttxt = v.findViewById(R.id.scheme3_withspare_totalspare_counttxt);
        scheme3_withspare_limitedspare_counttxt = v.findViewById(R.id.scheme3_withspare_limitedspare_counttxt);

        scheme3_withspare_totalspare_plusbtn = v.findViewById(R.id.scheme3_withspare_totalspare_plusbtn);
        scheme3_withspare_limitedspare_plusbtn = v.findViewById(R.id.scheme3_withspare_limitedspare_plusbtn);

        scheme3_withspare_totalspare_progressbar = v.findViewById(R.id.scheme3_withspare_totalspare_progressbar);
        scheme3_withspare_limitedspare_progressbar = v.findViewById(R.id.scheme3_withspare_limitedspare_progressbar);
        ...
        cart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                scheme3_withspare_totalspare_counttxt.setText("" + totalsparedatabaseQvalue);
                int inttotalsparedatabaseQvalue = Integer.parseInt(totalsparedatabaseQvalue);
                if (inttotalsparedatabaseQvalue <= 0) {
                    scheme3_withspare_totalspare_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    scheme3_withspare_totalspare_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        cart.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                scheme3_withspare_limitedspare_counttxt.setText("" + limitedsparedatabaseQvalue);
                int intlimitedsparedatabaseQvalue = Integer.parseInt(limitedsparedatabaseQvalue);
                if (intlimitedsparedatabaseQvalue <= 0) {
                    scheme3_withspare_limitedspare_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    scheme3_withspare_limitedspare_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        scheme3_withspare_totalspare_addbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                scheme3_withspare_totalspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_totalspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withspare_totalspare_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withspare_totalspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_totalspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withspare_totalspare_subbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withspare_totalspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_totalspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withspare_limitedspare_addbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                scheme3_withspare_limitedspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_limitedspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withspare_limitedspare_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withspare_limitedspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_limitedspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withspare_limitedspare_subbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withspare_limitedspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withspare_limitedspare_progressbar.setVisibility(View.VISIBLE);
    ...
    private void btn(String action) {
        if(action=="false") {
            scheme3_withspare_totalspare_cardview1.setEnabled(false);
            scheme3_withspare_totalspare_plusbtn.setEnabled(false);
            scheme3_withspare_totalspare_subbtn.setEnabled(false);
            scheme3_withspare_limitedspare_cardview1.setEnabled(false);
            scheme3_withspare_limitedspare_plusbtn.setEnabled(false);
            scheme3_withspare_limitedspare_subbtn.setEnabled(false);
        }
        else if(action=="true") {
            scheme3_withspare_totalspare_cardview1.setEnabled(true);
            scheme3_withspare_totalspare_plusbtn.setEnabled(true);
            scheme3_withspare_totalspare_subbtn.setEnabled(true);
            scheme3_withspare_limitedspare_cardview1.setEnabled(true);
            scheme3_withspare_limitedspare_plusbtn.setEnabled(true);
            scheme3_withspare_limitedspare_subbtn.setEnabled(true);
        }
    }
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            scheme3_withspare_totalspare_cardview2.setVisibility(View.VISIBLE);
                            scheme3_withspare_totalspare_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                    ...
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(totalsparecount<=0) {
                                scheme3_withspare_totalspare_cardview2.setVisibility(View.INVISIBLE);
                                scheme3_withspare_totalspare_cardview1.setVisibility(View.VISIBLE);
                                scheme3_withspare_totalspare_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
                            else
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            cart.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).updateChildren(cartt);
                            scheme3_withspare_limitedspare_cardview2.setVisibility(View.VISIBLE);
                            scheme3_withspare_limitedspare_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                    ...
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(limitedsparecount<=0) {
                                scheme3_withspare_limitedspare_cardview2.setVisibility(View.INVISIBLE);
                                scheme3_withspare_limitedspare_cardview1.setVisibility(View.VISIBLE);
                                scheme3_withspare_limitedspare_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
                            else
