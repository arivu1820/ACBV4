...
public class splitac_scheme3_withoutspare_bsd extends BottomSheetDialogFragment {

    private String Maincategory = "Scheme3",Category = "Withoutspare";
    private CardView scheme3_withoutspare_cardview1,scheme3_withoutspare_cardview2;
    private CardView scheme3_withoutspare_progressbar;
    private Button scheme3_withoutspare_addbtn;
    private Button scheme3_withoutspare_subbtn;
    private TextView scheme3_withoutspare_counttxt;
    private Button scheme3_withoutspare_plusbtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_splitac_scheme3_withoutspare_bsd, container, false);

        footer = v.findViewById(R.id.footer);

        scheme3_withoutspare_cardview1 = v.findViewById(R.id.scheme3_withoutspare_cardview1);
        scheme3_withoutspare_cardview2 = v.findViewById(R.id.scheme3_withoutspare_cardview2);

        scheme3_withoutspare_addbtn  = v.findViewById(R.id.scheme3_withoutspare_addbtn);

        scheme3_withoutspare_subbtn = v.findViewById(R.id.scheme3_withoutspare_subbtn);

        scheme3_withoutspare_counttxt = v.findViewById(R.id.scheme3_withoutspare_counttxt);

        scheme3_withoutspare_plusbtn = v.findViewById(R.id.scheme3_withoutspare_plusbtn);

        scheme3_withoutspare_progressbar = v.findViewById(R.id.scheme3_withoutspare_progressbar);
        ...
        root.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String stringtotalspare = snapshot.child("Products").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("Price").child("Nospare").getValue().toString();
        ...
        discount.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String disstringtotalspare = snapshot.child("Products").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("Discount").child("Nospare").getValue().toString();
        ...
        cart.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String nosparedatabaseQvalue = snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("Nospare").getValue().toString();
                scheme3_withoutspare_counttxt.setText("" + nosparedatabaseQvalue);
                int intnosparedatabaseQvalue = Integer.parseInt(nosparedatabaseQvalue);
                if (intnosparedatabaseQvalue <= 0) {
                    scheme3_withoutspare_cardview2.setVisibility(View.INVISIBLE);
                } else {
                    scheme3_withoutspare_cardview2.setVisibility(View.VISIBLE);
                }
            }
        ...
        scheme3_withoutspare_addbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                scheme3_withoutspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withoutspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withoutspare_plusbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withoutspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withoutspare_progressbar.setVisibility(View.VISIBLE);
        ...
        scheme3_withoutspare_subbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scheme3_withoutspare_cardview1.setVisibility(View.INVISIBLE);
                scheme3_withoutspare_progressbar.setVisibility(View.VISIBLE);
    ...
    private void btn(String action) {
        if(action=="false") {
            scheme3_withoutspare_cardview1.setEnabled(false);
            scheme3_withoutspare_plusbtn.setEnabled(false);
            scheme3_withoutspare_subbtn.setEnabled(false);
        }
        else if(action=="true") {
            scheme3_withoutspare_cardview1.setEnabled(true);
            scheme3_withoutspare_plusbtn.setEnabled(true);
            scheme3_withoutspare_subbtn.setEnabled(true);
        }
    }
            ...
            Runnable run = new Runnable() {
                ...
                public void run() {
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            String stringwithoutsparecount = snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("Nospare").getValue().toString();
                            ...
                            scheme3_withoutspare_cardview2.setVisibility(View.VISIBLE);
                            scheme3_withoutspare_progressbar.setVisibility(View.INVISIBLE);
                            btn("true");
                        }
                    ...
                    cart.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(withoutsparecount<=0) {
                                scheme3_withoutspare_cardview2.setVisibility(View.INVISIBLE);
                                scheme3_withoutspare_cardview1.setVisibility(View.VISIBLE);
                                scheme3_withoutspare_progressbar.setVisibility(View.INVISIBLE);
                                btn("true");
                            }
                            else
    ...
    private void withoutspareprice(String action,int price) {
        ...
        if (action == "add") {
            cart.addListenerForSingleValueEvent((new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    String stringtotalsparecount = snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("NospareTOTAL").getValue().toString();
            ...
            cart.addListenerForSingleValueEvent((new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    String stringtotalsparecount = snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("NospareTOTAL").getValue().toString();
                    int totalsparecount = Integer.parseInt(stringtotalsparecount);
                    int totalsparediscount = Integer.parseInt(snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("Addcart").child("AMC").child("SplitAC").child(Maincategory).child(Category).child("Nospare").getValue().toString());
